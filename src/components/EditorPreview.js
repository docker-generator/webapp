...
export default function EditorPreview() {
  ...
  return (
    <containers.col_right
      style={ { width: '50%', height: '100%', backgroundColor: colors.secondary_20, borderRadius: '8px' } }>
      <containers.row_center noPadding style={ { marginBottom: '15px' } }>
        <styles.editor_container style={ { marginTop: '30px' } }>
          <EditorPreviewContent data={ data } />
        </styles.editor_container>
      </containers.row_center>
      <containers.row_left noPadding style={ { backgroundColor: colors.primary_70, height: '80px', borderRadius: '8px' } }>
